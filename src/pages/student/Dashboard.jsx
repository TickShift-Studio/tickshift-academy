...
export default function StudentDashboard() {
  ...
  if (!hasAccess && membershipChecked) return (
    <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', minHeight: '100vh', background: '#08162E', padding: '2rem', textAlign: 'center', gap: 16 }}>
      ...
      <a href="https://whop.com/tikcshift/tickshift-premium-access/" target="_blank" rel="noopener noreferrer" style={{ padding: '0.75rem 2rem', marginTop: 8, background: 'linear-gradient(135deg, #0F6FFF, #3CCBFF)', border: 'none', borderRadius: 10, color: '#fff', fontFamily: "'Montserrat', sans-serif", fontWeight: 700, fontSize: 13, letterSpacing: 1, textDecoration: 'none', textTransform: 'uppercase' }}>Get Access on Whop</a>
    </div>
  )
